...
Blockly.Blocks['ds18b20_config'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField(Blockly.Msg.ARD_STEPPER_SETUP) // Setup Temp. sensor
        .appendField(
            new Blockly.FieldInstance('ds18b20',
                                      Blockly.Msg.ARD_STEPPER_DEFAULT_NAME, // MyTempSensor
                                      true, true, false),
            'DS18B20_NAME')
        .appendField(Blockly.Msg.ARD_STEPPER_MOTOR); // :
    this.appendDummyInput('PINS')
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.Msg.ARD_STEPPER_PIN1) // Pin
        .appendField(new Blockly.FieldDropdown(
            Blockly.Arduino.Boards.selected.digitalPins), 'DS18B20_PIN');
    this.setTooltip(Blockly.Msg.ARD_STEPPER_SETUP_TIP); // Configures a temperature sensor
  }
};
