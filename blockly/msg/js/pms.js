...
Blockly.Msg.ARD_DS18B20_DEFAULT_NAME = "MyTempSensor";  // untranslated
Blockly.Msg.ARD_DS18B20_GET_TEMP_GET = "Get temperature of";  // untranslated
Blockly.Msg.ARD_DS18B20_GET_TEMP_TIP = "Get the temperature value in °C of the last measurement";  // untranslated
Blockly.Msg.ARD_DS18B20_MEASURE_MEASURE = "Measure";  // untranslated
Blockly.Msg.ARD_DS18B20_MEASURE_TIP = "Tell the sensor to measure the temperature";  // untranslated
Blockly.Msg.ARD_DS18B20_PIN = "pin";  // untranslated
Blockly.Msg.ARD_DS18B20_SETUP = "Setup temperatur sensor";  // untranslated
Blockly.Msg.ARD_DS18B20_SETUP2 = ":";  // untranslated
Blockly.Msg.ARD_DS18B20_SETUP_TIP = "Setup DS18B20 temperatur sensor";  // untranslated
...
Blockly.Msg.ARD_HALL_TEXT = "read magnet sensor";  // untranslated
Blockly.Msg.ARD_HALL_TIP = "reads the hall sensor of an ESP32";  // untranslated
Blockly.Msg.ARD_HIGH = "HIGH";  // untranslated
Blockly.Msg.ARD_HIGHLOW_TIP = "Set a pin state logic High or Low.";  // untranslated
Blockly.Msg.ARD_IFTTT_KEY = "API Key";  // untranslated
Blockly.Msg.ARD_IFTTT_NAME = "Webhook name";  // untranslated
Blockly.Msg.ARD_IFTTT_SETUP = "Setup IFTTT Webhook";  // untranslated
Blockly.Msg.ARD_IFTTT_SETUP2 = ":";  // untranslated
Blockly.Msg.ARD_IFTTT_SETUP_TIP = "Create a IFTTT Webhook you can trigger later.";  // untranslated
Blockly.Msg.ARD_IFTTT_TRIGGER = "trigger";  // untranslated
Blockly.Msg.ARD_IFTTT_TRIGGER_MSG_1 = "Message 1";  // untranslated
Blockly.Msg.ARD_IFTTT_TRIGGER_MSG_2 = "Message 2";  // untranslated
Blockly.Msg.ARD_IFTTT_TRIGGER_MSG_3 = "Message 3";  // untranslated
Blockly.Msg.ARD_IFTTT_TRIGGER_MSG_TIP = "Trigger a IFTTT webhook with up to tree messages.";  // untranslated
Blockly.Msg.ARD_IFTTT_TRIGGER_TIP = "Trigger a IFTTT webhook.";  // untranslated
Blockly.Msg.ARD_IFTTT_WEBHOOK_NAME = "myIFTTTWebhook";  // untranslated
Blockly.Msg.ARD_IR_CHECK = "got IR signal?";  // untranslated
Blockly.Msg.ARD_IR_CHECK_PIN = "Pin";  // untranslated
Blockly.Msg.ARD_IR_CHECK_TIP = "chose the IR pin where you want a result from";  // untranslated
Blockly.Msg.ARD_IR_RESULT = "received IR signal from Pin";  // untranslated
Blockly.Msg.ARD_IR_RESULT_TIP = "chose the IR pin where you got a result";  // untranslated
Blockly.Msg.ARD_LOW = "LOW";  // untranslated
Blockly.Msg.ARD_MAP = "Map";  // untranslated
Blockly.Msg.ARD_MAP_IN_MAX = "max";  // untranslated
Blockly.Msg.ARD_MAP_IN_MIN = "from min";  // untranslated
Blockly.Msg.ARD_MAP_OUT_MAX = "max";  // untranslated
Blockly.Msg.ARD_MAP_OUT_MIN = "to min";  // untranslated
Blockly.Msg.ARD_MAP_TIP = "Re-maps a number from [min-max] to another.";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_0 = "Setup led strip";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_1 = "myLedStrip";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_10 = "show RGB LEDs";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_11 = "Hue:";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_12 = "Saturation:";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_13 = "Value:";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_2 = ":";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_3 = "Data pin";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_4 = "Number of leds";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_5 = "Set RGB LED";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_6 = "At position:";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_7 = "Red:";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_8 = "Green:";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_9 = "Blue:";  // untranslated
Blockly.Msg.ARD_NEOPIXEL_TIP = "Connect to a NeoPixel LED strip";  // untranslated
...
Blockly.Msg.ARD_THING_SPEAK_CHANNEL = "Channel:";  // untranslated
Blockly.Msg.ARD_THING_SPEAK_FIELD = "Field:";  // untranslated
Blockly.Msg.ARD_THING_SPEAK_KEY = "Key:";  // untranslated
Blockly.Msg.ARD_THING_SPEAK_SEND = "Send value to ThingSpeak";  // untranslated
Blockly.Msg.ARD_THING_SPEAK_VALUE = "Value:";  // untranslated
...
Blockly.Msg.ARD_TIME_DROPDOWN_DAY_OF_MONTH = "day of month";  // untranslated
Blockly.Msg.ARD_TIME_DROPDOWN_HOUR = "hour";  // untranslated
Blockly.Msg.ARD_TIME_DROPDOWN_MIN = "minute";  // untranslated
Blockly.Msg.ARD_TIME_DROPDOWN_MONTH = "month";  // untranslated
Blockly.Msg.ARD_TIME_DROPDOWN_SEC = "second";  // untranslated
Blockly.Msg.ARD_TIME_DROPDOWN_YEAR = "year";  // untranslated
Blockly.Msg.ARD_TIME_GET_CURRENT = "get the current";  // untranslated
Blockly.Msg.ARD_TIME_GET_CURRENT_TIP = "Returns the current second. Can be set by the 'Set time via wifi' block.";  // untranslated
...
Blockly.Msg.ARD_TIME_WIFI_SET = "set time via wifi";  // untranslated
Blockly.Msg.ARD_TIME_WIFI_SET_TIP = "Sets the system time using time servers. Uses Wifi of the ESP32.";  // untranslated
...
Blockly.Msg.ARD_TOUCH_READ_MSG = "Read touch sensor";  // untranslated
Blockly.Msg.ARD_TOUCH_READ_TIP = "Read touch sensor of ESP32. Values get smaller if touched.";  // untranslated
Blockly.Msg.ARD_TOUCH_WARN = "This board has no touch sensors";  // untranslated
Blockly.Msg.ARD_TOUCH_WAS_TOUCHED_MSG = "was touched?";  // untranslated
Blockly.Msg.ARD_TOUCH_WAS_TOUCHED_TIP = "Check if a touch sensor of the ESP32 was touched (since the last time this was checked).";  // untranslated
...
Blockly.Msg.ARD_WIFI_PASSWORD = "WLAN password";  // untranslated
Blockly.Msg.ARD_WIFI_SSID = "WLAN name";  // untranslated
Blockly.Msg.ARD_WIFI_TIP = "Connect to your wifi";  // untranslated
Blockly.Msg.ARD_WIFI_WIFI = "Connect to Wifi:";  // untranslated
